...
function RuleVisual({ gameId }: { gameId: GameId }) {
  ...
  if (gameId === "rummikub") return <figure className="rule-visual rummikub" role="img" aria-label="빨강 7 8 9 런과 여러 색 11 그룹"><div className="rummi-rule-sets"><span className="red">7</span><span className="red">8</span><span className="red">9</span><i>+</i><span className="blue">11</span><span className="yellow">11</span><span className="black">11</span></div><div className="rummi-rule-badges"><b>최초 30점</b><b>테이블 재배치</b><b>★ 조커</b></div><figcaption>그룹과 런을 만들고 내 타일을 모두 내려놓으세요</figcaption></figure>;
  if (gameId === "word-defense") return <figure className="rule-visual word-defense" role="img" aria-label="아래로 내려오는 단어 적과 BOOM 협동 공격"><div className="defense-rule-lanes"><span style={{ left: "13%", top: "12%" }}>별빛</span><span style={{ left: "57%", top: "38%" }}>keyboard</span><b>BOOM!</b><i>⌨</i></div><div className="defense-rule-badges"><b>2~8명 협동</b><b>3분</b><b>랭킹 미반영</b></div><figcaption>단어를 입력해 적을 터뜨리고 기지를 지키세요</figcaption></figure>;
